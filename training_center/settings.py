...
SECRET_KEY = 'django-insecure-*l*klf$gfixv-as*&=21gv1+-p4-pseac(okqtk1!3+dapl0)%'
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware',  # должен идти после SessionMiddleware
...
LOCALE_PATHS = [
    BASE_DIR / 'locale',  # для файлов перевода
]
